...
<body>
    ...
    <div class="full-car-show">
        <div class="full-center-car-show">
            ...
            <img class="p-8 rounded-t-lg ml-40" src="http://localhost/projects/cardetails/storage/app/public/{{ $row->image }}" width="1000px" height="800px" />
        </div>
    </div>
    <!-- component -->
                ...
                <div class="overflow-hidden">
                    <table class="min-w-full text-center">
                        <thead class="bg-white border-b">
                            <tr>
                                <th scope="col" colspan="4" class="text-lg font-large text-gray-900 px-6 py-4 text-left pl-20">
    ...
    <div class="review-section">
        <div class="review-section-center  ">
            <div class="flex mx-auto w-full m-auto items-center justify-center shadow-lg pt-5">
                ...
                @endif
                <form class="w-full max-w-5xl bg-white rounded-lg px-4 pt-2" method="post" action="{{ url('review-submit')}}">

                    @csrf
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <h2 class="px-4 pb-2 text-gray-800 text-lg">Add a Review</h2>
                        <div class="w-full md:w-full px-3 mb-2  ">
                            <textarea type="text" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-15 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" name="review" placeholder='Type Your Review' required></textarea>
                            @if (Auth::user())
                            ...
                            <div class="w-full md:w-full flex items-start md:w-full px-2">
                                <div class="-mr-1">
                                    @if (Auth::user())
                                    <input type='submit' class="bg-white text-gray-700 font-medium py-1 px-4 border border-gray-400 rounded-lg tracking-wide  hover:bg-gray-100" value='Post Review'>
                                    @else
                                    <a href="http://localhost/projects/cardetails/public/login"> <input type='button' class="bg-white text-gray-700 font-medium py-1 px-4 border border-gray-400 rounded-lg tracking-wide  hover:bg-gray-100" value='First login your account'></a>
                                    @endif
                                </div>
                            </div>
                </form>
    ...
    <div class="review-section1">
        <div class="review-section-center1  ">
            ...
            <!-- post card -->
            <div class="flex bg-white shadow-lg rounded-lg mx-4 md:mx-auto my-5 max-w-md md:max-w-7xl border border-gray-300">
