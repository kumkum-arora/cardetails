...
<body style="background-color: #e9ecef;">
    ...
    <div class="preheader"
        ...
        {{ $user['fullname'] }} Thank you for registered your account in our website carwale.
    </div>
    <!-- end preheader -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Tap the button below to confirm your email address. If you did not
                                create an account on carwale, you can safely delete
                                this email.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href="http://localhost/projects/cardetails/public/verify/ {{ $user['id'] }}"
                                                        target="_blank"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br>Carwale</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">instagram 1234 S. Broadway St. City, State 12345</p>
                        </td>
                    </tr>
                    <!-- end unsubscribe -->
